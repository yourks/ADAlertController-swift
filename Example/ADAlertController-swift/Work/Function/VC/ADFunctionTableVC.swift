...
class ADFunctionTableVC: ADBaseVC,UITextFieldDelegate {
    ...
    lazy var mainTableV :UITableView = {
        ...
        tw.delegate = self
        tw.dataSource = self
        tw.backgroundColor = UIColor.red
        tw.separatorStyle = .none
        tw.register(ADFunctionTableCell.self, forCellReuseIdentifier: "ADFunctionTableCell")
        return tw;
    }()
    
    
    //MARK:需要学习一种转换模型的框架
    func getData() -> Array<ADFunctionModel> {
        var functionArr :Array = [ADFunctionModel]()
        ...
        let functionDictArr :Array = [
            ...
            ["title":"黑名单时不显示","selector":"blackListSample"],
        ]
...
extension ADFunctionTableVC {
    @objc func alertStyleTitleOnly() {
        ...
        let cancelAction :ADAlertAction = ADAlertAction.actionWithTitle("取消", ADActionStyle.ADActionStyleCancel) { (alertAction) in
            print("点击了取消");
        }

        let sureAction :ADAlertAction = ADAlertAction.actionWithTitle("确定", ADActionStyle.ADActionStyleDefault) { (alertAction) in
            print("点击了确定");
        }

        let alertView :ADAlertController = ADAlertController(configuration: ADAlertControllerConfiguration.defaultConfigurationWithPreferredStyle(preferredStyle: ADAlertControllerStyle.ADAlertControllerStyleAlert), title: "这里是标题", message: "", actions: [cancelAction , sureAction])
    ...
    @objc func alertStyleMessageOnly() {
        ...
        let alertView :ADAlertController = ADAlertController(configuration: ADAlertControllerConfiguration.defaultConfigurationWithPreferredStyle(preferredStyle: ADAlertControllerStyle.ADAlertControllerStyleAlert), title: "", message:"这里是内容", actions: [cancelAction , sureAction])
    ...
    @objc func alertStyleMultipButton()  {
        ...
        let actionConfig :ADAlertActionConfiguration = ADAlertActionConfiguration.defaultConfigurationWithActionStyle(style: ADActionStyle.ADActionStyleDefault)
        
        let action1 :ADAlertAction = ADAlertAction.actionWithTitleFull("WiFi 或者 移动网络", nil, ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("选择了WiFi 或者 移动网络");
        }, configuration: actionConfig)
        
        let action2 :ADAlertAction = ADAlertAction.actionWithTitleFull("移动网络", nil, ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("选择了移动网络");
        }, configuration: actionConfig)

        let action3 :ADAlertAction = ADAlertAction.actionWithTitleFull("WiFi", nil, ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("选择了WiFi");
        }, configuration: actionConfig)

        let action4 :ADAlertAction = ADAlertAction.actionWithTitleFull("不允许网络访问", nil, ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("选择了不允许网络访问");
        }, configuration: actionConfig)
    ...
    @objc func alertStyleImageButton()  {
        ...
        let action1 :ADAlertAction = ADAlertAction.actionWithTitleFull(nil, UIImage(named: "share_1"), ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("share_1");
        }, configuration: actionConfig)
        
        let action2 :ADAlertAction = ADAlertAction.actionWithTitleFull(nil, UIImage(named: "share_2"), ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("share_2");
        }, configuration: actionConfig)

        let action3 :ADAlertAction = ADAlertAction.actionWithTitleFull(nil, UIImage(named: "share_3"), ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("share_3");
        }, configuration: actionConfig)

        let action4 :ADAlertAction = ADAlertAction.actionWithTitleFull(nil, UIImage(named: "share_4"), ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("share_4");
        }, configuration: actionConfig)

        let action5 :ADAlertAction = ADAlertAction.actionWithTitleFull(nil, UIImage(named: "share_5"), ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("share_5");
        }, configuration: actionConfig)
    ...
    @objc func alertStyleGroupButtons()  {
        ...
        let action5 :ADAlertAction = ADAlertAction.actionWithTitleFull("短信", nil, ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("短信");
        }, configuration: actionConfig)
...
//        let alertView :ADAlertController = ADAlertController(configuration:config, title: "这里是标题", message:nil, actions: [group])
    ...
    @objc func alertStyleImageAction()  {
        ...
        let action1 :ADAlertAction = ADAlertAction.actionWithTitleFull("QQ", UIImage(named: "share_1"), ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("share_1");
        }, configuration: actionConfig)
        
        let action2 :ADAlertAction = ADAlertAction.actionWithTitleFull("QQ空间", UIImage(named: "share_2"), ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("share_2");
        }, configuration: actionConfig)

        let action3 :ADAlertAction = ADAlertAction.actionWithTitleFull("短信", UIImage(named: "share_3"), ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("share_3");
        }, configuration: actionConfig)

        let action4 :ADAlertAction = ADAlertAction.actionWithTitleFull("朋友圈", UIImage(named: "share_4"), ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("share_4");
        }, configuration: actionConfig)

        let action5 :ADAlertAction = ADAlertAction.actionWithTitleFull("微信", UIImage(named: "share_5"), ADActionStyle.ADActionStyleCancel, complete: { (ADAlertAction) in
            print("短信");
        }, configuration: actionConfig)
...
//        let alertView :ADAlertController = ADAlertController(configuration:config, title: "这里是标题", message:nil, actions: [group,action5,action5])
    ...
    @objc func actionSheetStyleTitleOnly()  {
        let cancelAction :ADAlertAction = ADAlertAction.actionWithTitle("取消", ADActionStyle.ADActionStyleSheetCancel) { (alertAction) in
            print("点击了取消");
        }

        let config :ADAlertControllerConfiguration = ADAlertControllerConfiguration(preferredStyle: ADAlertControllerStyle.ADAlertControllerStyleActionSheet)
        config.showsSeparators = true
    ...
    @objc func actionSheetStyleMultipButton()  {
        ...
        let cancelAction1 :ADAlertAction = ADAlertAction.actionWithTitle("添加", ADActionStyle.ADActionStyleDefault) { (alertAction) in
            print("点击了取消");
        }
        let cancelAction2 :ADAlertAction = ADAlertAction.actionWithTitle("编辑", ADActionStyle.ADActionStyleDefault) { (alertAction) in
            print("点击了取消");
        }
        
        let cancelAction3 :ADAlertAction = ADAlertAction.actionWithTitle("删除", ADActionStyle.ADActionStyleDestructive) { (alertAction) in
            print("点击了取消");
        }
...
//    }
    ...
    @objc func sheetStyle()  {
        ...
        let config :ADAlertControllerConfiguration = ADAlertControllerConfiguration(preferredStyle: ADAlertControllerStyle.ADAlertControllerStyleSheet)
        config.showsSeparators = true
        config.messageTextInset = UIEdgeInsets.init(top: 0, left: 10, bottom: 20, right: 10)
...
//        }
        ...
        for index :NSInteger in 0..<10 {
            ...
            let style :ADAlertControllerStyle = (index % 2 == 0) ?ADAlertControllerStyle.ADAlertControllerStyleAlert : ADAlertControllerStyle.ADAlertControllerStyleSheet
